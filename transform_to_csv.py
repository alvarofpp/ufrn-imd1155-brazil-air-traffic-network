...
df_airfields = pd.read_csv('data/AerodromosPublicos.csv', sep=';', usecols=airfields_columns, skiprows=1)
...
df_others_airports = pd.read_csv('data/airport-codes_csv.csv', usecols=others_airports_columns)
